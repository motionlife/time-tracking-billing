        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-headline">
                <div class="panel-heading">
                    ...
                    <?php $start = Carbon\Carbon::parse('last week'); ?>
                    <p class="panel-subtitle">Period: {{$start->format('M d, Y')}}
                        - {{$start->addDays(6)->format('M d, Y')}}</p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="metric">
                                ...
                                <p>
                                    <span class="number">{{number_format($data['weekly'][7][0],1)}}</span>
                        ...
                        <div class="col-md-3">
                            <div class="metric">
                                ...
                                <p>
                                    <span class="number">{{number_format($data['weekly'][7][1],1)}}</span>
                        ...
                        <div class="col-md-3">
                            <div class="metric">
                                ...
                                <p>
                                    <span class="number">${{number_format($data['weekly'][7][2],2)}}</span>
                                    <span class="title">Weekly Wage</span>
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(function () {
            ...
            data = {
                ...
                series: [
                    [{{$data['weekly'][0]['bh']}}, {{$data['weekly'][1]['bh']}}, {{$data['weekly'][2]['bh']}}, {{$data['weekly'][3]['bh']}}, {{$data['weekly'][4]['bh']}}, {{$data['weekly'][5]['bh']}}, {{$data['weekly'][6]['bh']}}],
                    [{{$data['weekly'][0]['nbh']}}, {{$data['weekly'][1]['nbh']}}, {{$data['weekly'][2]['nbh']}}, {{$data['weekly'][3]['nbh']}}, {{$data['weekly'][4]['nbh']}}, {{$data['weekly'][5]['nbh']}}, {{$data['weekly'][6]['nbh']}}],
                ]
            };
